  ...
  sections: [
    ...
    },
    {
      ...
      tips: [
        ...
        "אצלי כל קובץ הגדרה לשירות יושב ב-`/etc/nginx/sites-available/<service>.conf` — קל לערוך, לראות diff ב-git, ולהפעיל/לכבות בנפרד",
      ],
      codeExample: {
