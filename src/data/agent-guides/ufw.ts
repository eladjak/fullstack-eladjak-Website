...
export const ufwGuide: AgentGuideData = {
  ...
  paradigmTitle: "ברירת מחדל: חסום הכול",
  paradigmSub:
  ...
  sections: [
    ...
    },
    {
      ...
      tips: [
        ...
        "אם אתם מאחורי VPN של החברה (Tailscale, WireGuard), אפשר להגיד ל-UFW לאפשר רק מה-VPN: `ufw allow in on tailscale0`. כך אפילו SSH פתוח רק דרך ה-VPN",
        "הוסיפו `ufw allow from 10.0.0.0/8` כדי לאפשר את הכול מ-private network. שימושי ב-multi-server setups",
      ],
      codeExample: {
    ...
    },
    {
      ...
      subtitle: "השגיאות הנפוצות והפתרונות שלהן",
      description:
    ...
    },
    {
      ...
      subtitle: "מה עוד יש בסיסטם של Linux",
      description:
      ...
      tips: [
        "אצלי הקומבינציה: UFW + fail2ban + Cloudflare WAF (חלק מה-tier החינמי). שלוש שכבות הגנה בלי תשלום",
  ...
  resources: [
    ...
    },
    {
      ...
      description: "המדריך המומלץ ביותר למתחילים",
      href: "https://www.digitalocean.com/community/tutorials/how-to-set-up-a-firewall-with-ufw-on-ubuntu",
      icon: BookOpen,
    },
    {
      title: "ufw-docker",
      description: "התוסף שפותר את הבעיה של Docker שעוקף את UFW",
