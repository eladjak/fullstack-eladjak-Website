  ...
  sections: [
    {
      ...
      content: [
        ...
        "מדיה ונכסים (creative_visual), יצירת איורים, תמונות ונכסים ויזואליים (דרך Gemini/nano-banana). חשוב: את המדיה Hermes מספק; את הקופי שמלווה אותה כותב [ראנץ'](/guide/ranch)",
        "ניתוח-נתונים (data_analysis), עיבוד וניתוח של נתונים, חישובים, ותובנות שנכתבות ל-[האב-ידע](/guide/orchestration) או לתיבת-הנכנס",
