...
export const aiderGuide: AgentGuideData = {
  ...
  sections: [
    ...
    },
    {
      ...
      beginner:
        "למה כל הטרחה הזו של בידוד? חשבו על זה כמו על שני חשבונות בנק: אחד לעבודה ואחד לחיסכון. אם שניהם על אותו כרטיס אשראי, כל קנייה שורפת גם מהחיסכון. אותו דבר פה — אם Aider משתמש באותם מפתחות API של [Claude Code](/claude-code), כל שורת קוד שהוא יכתוב תיגרע מאותה מכסה חודשית. בידוד מלא = שקט נפשי. Aider רץ על חשבון חינמי של OpenRouter (שער שמציע מודלים חינמיים כמו Qwen 2.5 Coder:free של Alibaba Cloud ו-DeepSeek V3:free של DeepSeek), בזמן ש-[Claude Code](/claude-code) ממשיך לעבוד לו בצד על המנוי הראשי.",
      content: [
    ...
    },
    {
      ...
      content: [
        ...
        "Qwen 2.5 Coder 32B:free ו-Qwen 3 Coder של Alibaba Cloud, דרך OpenRouter — בין המודלים החינמיים הטובים ביותר לקוד. איטיים יותר ממודלים בתשלום ומוגבלים ב-rate limit ב-free tier, אבל בחינם מוחלט. אצלי (אלעד) זה ה-backup כש-[Claude Max](/claude-code) מגיע למכסה. אצלכם — אם אין Claude Pro/Max, זה יכול להיות הכלי הראשי. Qwen 3 Coder (הגרסה החדשה) זמין ב-tier בתשלום של OpenRouter במחיר תחרותי מאוד.",
