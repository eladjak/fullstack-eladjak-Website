...
export const crewaiGuide: AgentGuideData = {
  ...
  heroDescription: "CrewAI זו מסגרת תוכנה בקוד פתוח (ספריית Python) שמאפשרת לכם להקים צוות שלם של סוכני בינה מלאכותית שעובדים יחד — בדיוק כמו צוות אנשים אמיתי. במקום לבקש ממודל שפה אחד (כמו [Claude](/claude-code) או ChatGPT) לכתוב לכם מאמר שלם בבת אחת, אתם מגדירים שלושה-ארבעה 'עובדים וירטואליים', כל אחד עם התמחות שונה: חוקר שאוסף מקורות, אסטרטג שמחליט על זווית וכותרת, כותב שמנסח בטון מושך, ועורך שמשפר. CrewAI נולדה ב-2023 ככוכבת עולה בתחום ה-multi-agent (ריבוי סוכנים), והיא הפכה לאחת הפלטפורמות הפופולריות לבניית מערכות AI מתוחכמות בזכות הפשטות שלה: בכמה עשרות שורות קוד אתם מקבלים צוות שעובד יחד, מעביר מידע זה לזה, ומגיע לתוצאה עמוקה בהרבה ממודל בודד. אצלי (אלעד) רצים היום 10 צוותים שונים לייצור תוכן, מחקר ושיווק — אבל אצלכם CrewAI יכול לשמש לכל משימה שדורשת יותר מ-AI אחד: ניתוח דאטה מקצועי, סקירה של קוד מזוויות שונות, יצירת מערכות שיווק אוטונומיות, או כל תהליך עסקי שמורכב מכמה שלבי חשיבה שונים.",
