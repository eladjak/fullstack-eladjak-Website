...
export const crewaiGuide: AgentGuideData = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        "Agent זה סוכן בודד — מגדירים לו role (התפקיד, למשל 'כותב עברי' או 'חוקר שוק'), goal (המטרה שהוא שואף אליה), backstory (סיפור רקע שקובע את האישיות והסגנון שלו), ו-llm (איזה מודל מניע אותו — [Claude](/claude-code) Sonnet 4.6, Gemini 2.5, DeepSeek V3, או מודל מקומי דרך [Ollama](/guide/ollama))",
    ...
    },
    {
      ...
      content: [
        ...
        "קבלו Gemini API key חינמי מ-ai.google.dev — השכבה החינמית של Gemini 2.5 Flash מאפשרת עד ~15 בקשות בדקה ומכסה נדיבית של tokens ליום, מספיק בהחלט לעשרות ריצות של crew בפיתוח אישי",
    ...
    },
    {
      ...
      content: [
        ...
        "פתרון 2: להעביר את הסוכן הבעייתי ל-[Claude](/claude-code) Haiku 4.5 — הוא עוקב אחרי ReAct מצוין ועולה כ-$1 למיליון tokens נכנסים ו-$5 יוצאים (בערך 0.10$-0.20$ לריצה של פוסט בלוג טיפוסי). זול, יציב בהרבה מ-Gemini על ReAct",
        ...
        "פתרון 4: לשדרג ל-CrewAI לגרסה עדכנית (0.100+) — התמיכה ב-Gemini השתפרה משמעותית ב-2025. pip install --upgrade crewai",
      ],
      tips: [
