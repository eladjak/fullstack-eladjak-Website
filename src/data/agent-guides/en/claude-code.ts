  ...
  sections: [
    ...
    },
    {
      ...
      tips: [
        ...
        "You'll need an Anthropic subscription: Pro at $20/month (recommended for beginners, enough for most use cases), Max at $100/month (for heavy users), or pay-as-you-go API access (for developers building their own automations)",
        "Three models are available: Opus 4.7 (the strongest — one-million-word context window, ideal for complex tasks), Sonnet 4.6 (balanced default), and Haiku 4.5 (fast and cost-efficient for simple tasks)",
      ],
      codeExample: {
    ...
    },
    {
      ...
      content: [
        ...
        "Autopilot mode — Claude receives a large goal and works on its own until it's fully complete, including tests and deployment",
