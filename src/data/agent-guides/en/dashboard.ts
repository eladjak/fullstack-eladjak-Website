  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        "Network — the health status of all 12 agents in the network ([Kami](/en/guide/kami), [Kaylee](/en/guide/kaylee), [Hermes](/en/guide/hermes), [Box](/en/guide/box), [CrewAI](/en/guide/crewai), [Adopter](/en/guide/adopter) and more). A green/yellow/red light per agent, with latency and the last heartbeat timestamp",
