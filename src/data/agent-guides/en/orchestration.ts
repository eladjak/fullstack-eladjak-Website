  ...
  sections: [
    {
      ...
      content: [
        "Each agent focused on one role: [Kami](/en/guide/kami) = human interface (WhatsApp/voice), [Claude Code](/en/claude-code) = dev orchestration, [Hermes](/en/guide/hermes) = studio/worker (creative/data/code), [Kaylee](/en/guide/kaylee) = infra reliability + distribution. Around them, more specialists complete the nine: [Ranch](/en/guide/ranch) for content, [Aurora](/en/guide/aurora) for reflection, [Solis](/en/guide/solis) for support, [Box](/en/guide/box) for health, and [Sailaco](/en/guide/sailaco) for sales",
