...
export const kamiGuide: AgentGuideData = {
  ...
  heroDescription: "סוכן AI אישי על WhatsApp, מבוסס TypeScript + Bun, רץ 24/7 על VPS ומחובר דרך Green API. שכבת LLM: Claude Sonnet 4.5. קול: OpenAI Whisper לתמלול, Gemini TTS (Charon) לתשובות קוליות. זיכרון: Qdrant עם embeddings של Gemini (768 מימדים). אצלי (אלעד) הוא מנהל תזכורות, סיכום ערב, והקלטה בזמן נהיגה — אבל אצלך הוא יכול להיות תמיכת לקוחות, עוזר למידה, חבר-משפחה-דיגיטלי, או כל שימוש אחר של סוכן שפתי על טלפון.",
