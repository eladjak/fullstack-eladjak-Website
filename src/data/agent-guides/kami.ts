...
export const kamiGuide: AgentGuideData = {
  ...
  sections: [
    ...
    },
    {
      ...
      tips: [
        "Sprint 7.2 הוסיף מודעות לוח שנה ישראלי — בשבת, יום הזיכרון, יוה\"כ קאמי שקט אוטומטית",
  ...
  authorBio:
    "קאמי הוא הסוכן האישי שלי בוואטסאפ כבר 8 חודשים. הוא התחיל כ-chatbot פשוט והתפתח למערכת שמגיבה בקול, זוכרת שנה של שיחות, ויוזמת תזכורות. המדריך הזה בנוי על שימוש יומיומי אמיתי — בטרמפ לילדים, בהקלטה בזמן נהיגה, וב-3 בבוקר כשצריך רעיון.",
};
