...
export const qdrantGuide: AgentGuideData = {
  ...
  paradigmShifts: [
    ...
    },
    {
      ...
      after: "מיליוני וקטורים, filtering, metadata, שלך",
      icon: Database,
    },
    {
  ...
  sections: [
    {
      ...
      difficulty: "beginner",
      beginner:
        "חשבו על זה ככה: בספרייה רגילה, כדי למצוא ספר צריך לדעת את השם המדויק או את שם הסופר. במסד וקטורי כמו Qdrant אפשר לבוא ולהגיד 'אני מחפש משהו על בישול צמחוני עם טעם ים-תיכוני', והוא ימצא לכם ספרים רלוונטיים, גם אם המילים שיחזרו עם השם אף פעם לא הופיעו בשאילתה שלכם. זו בדיוק היכולת שמאפשרת לסוכני AI כמו [Kami](/guide/kami) ו-[Box](/guide/box) 'לזכור' את השיחות שלכם איתם לפי מה שנאמר, ולא לפי המילים המדויקות.",
      content: [
      ...
      tips: [
        "התקנה ב-docker-compose, ראו את [המדריך ל-Docker](/guide/docker) לפרטים על networks, volumes ואיך להגדיר את זה כ-persistent",
        "אם אתם משתמשים ב-[CrewAI](/guide/crewai) או בסוכן שלכם עם [Claude](/claude-code), החיבור ל-Qdrant דרך LangChain או דרך הקוד הישיר הוא פקודה אחת; הספרייה (qdrant-client) ב-Python מעולה",
      ],
      codeExample: {
    ...
    },
    {
      ...
      beginner:
        "דמיינו שלכל משפט בעולם יש קואורדינטה ייחודית על 'מפה' תלת-ממדית (או במקרה שלנו, 768-ממדית). משפטים עם משמעות דומה, 'אכלתי סלט' ו'הכנתי צהריים בריא', יקבלו קואורדינטות קרובות אחת לשנייה על המפה הזו. משפטים רחוקים במשמעות, 'אכלתי סלט' ו'תיקנתי את המכונית', יקבלו קואורדינטות רחוקות. זה כל הקסם: כשאתם מחפשים משהו, אתם בעצם שואלים 'אילו קואורדינטות במפה הכי קרובות לשלי?'",
      content: [
        "gemini-embedding-001 של גוגל, חינמי לחלוטין, מחזיר וקטור של 768 מספרים ועובד יוצא מהכלל גם בעברית (זו הבחירה שלי אצלי)",
        "OpenAI text-embedding-3-small, עולה בערך $0.02 למיליון טוקנים, 1536 מימדים (מתאים אם אתם כבר משלמים ל-OpenAI). גרסה גדולה יותר text-embedding-3-large נותנת 3,072 מימדים בתמורה יקרה יותר",
        "Voyage voyage-3, 1,024 מימדים, נחשב הכי איכותי לאנגלית בעולמות ה-RAG היום, אבל בתשלום",
        ...
        "חשוב מאוד: אי אפשר לבצע חיפוש משותף בין collection אחד ל-collection אחר אם הם משתמשים במודלים שונים או במימד שונה (dimension), המפה של כל מודל היא שפה שונה",
      ],
      tips: [
        ...
        "אל תחליפו אף פעם מודל embedding אחרי שיש לכם data ב-collection, תצטרכו לעשות re-indexing (בנייה מחדש של כל הוקטורים מאפס), כי כל מודל מדבר 'שפה' אחרת של מספרים; ראו את [המדריך ל-Adopter](/guide/adopter) לדוגמה של ניהול embeddings במקום אחד",
      ],
      codeExample: {
    ...
    },
    {
      ...
      content: [
        "Collection היא המקבילה של 'טבלה' בבסיס נתונים רגיל, מוגדרת פעם אחת עם שם, גודל וקטור (dimension) וסוג מדד מרחק (distance metric)",
        "Point הוא המקבילה של 'שורה' בטבלה, מורכב מ-id (מזהה), vector (טביעת האצבע המספרית) ו-payload (JSON חופשי עם כל מטא-דאטה שתרצו)",
        "Distance metric (איך מודדים 'דמיון'): Cosine similarity (זווית בין וקטורים, מומלץ לטקסט), Euclidean (מרחק ישר), או Dot product (מכפלה פנימית)",
        ...
        "אצלי ברשת: kami_memory (1,000 הודעות וואטסאפ של [Kami](/guide/kami)), kaylee_memory (הזיכרון של [Kaylee](/guide/kaylee)), agents_registry (מי-עושה-מה), healing_history (מה ריפא [Hermes](/guide/hermes) בעבר), network_memory, telegram_news ועוד",
    ...
    },
    {
      ...
      content: [
        "נקודת הכניסה לחיפוש: POST /collections/<name>/points/search, תמיד שליחה של הוקטור יחד עם פרמטרים",
        ...
        "Score של דמיון מגיע בין 0 ל-1 בשיטת Cosine: 1.0 = משפטים זהים, 0.85 = קרובים מאוד, 0.5 = כבר לא קשורים במיוחד",
    ...
    },
    {
      ...
      subtitle: "מה באמת נשמר ב-Qdrant",
      description:
      ...
      difficulty: "advanced",
      beginner:
        "עד עכשיו דיברנו על איך Qdrant עובד; כאן רואים למה הוא שווה את זה, דרך דוגמאות חיות. כל אחד מהפריטים למטה הוא 'מגירת זיכרון' של הרשת שלי (אלעד): אחת זוכרת על מה דיברתי בוואטסאפ עם [Kami](/guide/kami), אחת זוכרת אילו תקלות כבר תוקנו בעבר, אחת זוכרת אילו כלים חדשים נמצאו. הנקודה המשותפת: כל אלה זיכרון שמחפשים בו 'לפי משמעות', לא לפי מילה מדויקת, וזה מה שהופך אוסף של סוכנים לרשת שזוכרת ולומדת, במקום מערכת ששוכחת הכל בכל בוקר.",
      content: [
        ...
        "agents_registry, רישום חי של כל הסוכנים ברשת עם תיאור מה כל אחד עושה. כשאני שואל משהו כמו 'מה [Hermes](/guide/hermes) עושה?' מקבלים תיאור מלא תוך פחות משנייה",
        "agent_status, heartbeat של כל השירותים, מתעדכן כל 5 דקות על ידי [Dashboard](/guide/dashboard). שאילתה סמנטית כמו 'אילו שירותים לא הגיבו היום?' מקבלת תשובה מיידית",
        "healing_history, ההיסטוריה של כל התיקונים האוטומטיים ש-[Hermes](/guide/hermes) ביצע. כשנופל container חדש, הוא שואל 'באיזה מצב דומה כבר הייתי בעבר, ומה תיקן אותו?' ומקבל רעיון ראשון מניסיון",
      ...
      tips: [
        "התחילו מ-collection אחד קטן ופשוט (למשל שיחות או מסמכים), אחרי שתבינו את הזרימה, תחלקו בהמשך לקולקשנים מיוחדים לפי נושא",
    ...
    },
    {
      ...
      difficulty: "advanced",
      beginner:
        "הסעיף הזה הוא הפרטים הקטנים שעושים את ההבדל בין 'יש לי Qdrant' ל'Qdrant שלי רץ מהר, חוסך כסף ומחזיק שנים'. אם להוציא מכל זה דבר אחד למי שלא מהתחום, הוא זה: גבו את הזיכרון שלכם. בדיוק כמו שלא הייתם משאירים אלבום תמונות משפחתי בלי עותק, אסור להשאיר את הזיכרון של המערכת בלי גיבוי, כי אם הוא נמחק, כל מה שהמערכת 'למדה' נעלם. אצלי (אלעד) יש גיבוי אוטומטי כל לילה. שאר הסעיף טכני יותר, אבל זה הלקח שאסור לדלג עליו.",
      content: [
        "Payload indexing, אם אתם מסננים הרבה לפי שדה מסוים ב-JSON (למשל 'year' או 'user_id'), הגדירו לו index ייעודי ב-Qdrant. זה מאיץ את ה-filter פי כמה וחוסך זמן סריקה",
        ...
        "Sparse vectors, בנוסף לוקטורים דחוסים (dense, אלה ה-embeddings הרגילים) אפשר לשמור גם וקטורים דלילים (sparse, בסגנון BM25, חיפוש לפי מילים ממש). שילוב של שניהם נותן hybrid search חזק במיוחד",
  ...
  ctaTitle: "Memory של הסוכנים שלך הוא ההבדל",
  ctaSub:
