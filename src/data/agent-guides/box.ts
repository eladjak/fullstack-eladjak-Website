...
export const boxGuide: AgentGuideData = {
  ...
  whoIsThisFor: [

    {
      ...
      description:
        ...
        "Box דורש רק וואטסאפ. בלי UI, בלי נטישה. עשרות פעמים ביום בקלות.",
  ...
  sections: [

    {
      ...
      description:
        ...
        "Box הוא מאמן אישי שחי בכיס שלכם — סוכן AI שמקבל הודעות בוואטסאפ (טקסט או תמונה), מבין מה אמרתם בשפה חופשית, זוכר את זה לטווח ארוך, ומחזיר תשובה עם הצעד הבא. הוא לא אפליקציה חדשה שצריך להוריד וללמוד; הוא שיחה בוואטסאפ, בדיוק כמו שיחה עם חבר שגם עוקב, גם מחשב וגם לא שופט.",
      ...
      beginner:
        ...
        "חשבו על יומן דיגיטלי עם מוח. אתם כותבים 'אכלתי בוריטו' בוואטסאפ — Box מבין שזו ארוחה, מעריך כמה קלוריות וחלבון היו בה, שומר את זה במאגר פנימי, ובסוף השבוע מחזיר לכם סיכום קצר. בלי אפליקציה, בלי הרשמה, בלי כפתורים. אצלי ([אלעד](/contact)) הוא מלווה תוכנית ירידה במשקל ובניית כוח, אבל אצלכם הוא יכול לעקוב אחרי שינה, ריצה, הרגלי לימוד או כל יעד אחר.",
...

    {
      ...
      content: [
        ...
        "האחסון: /opt/coach-data/progress-logs/intake.jsonl — קובץ JSONL (כל שורה היא JSON נפרד). פורמט עמיד, קל לגיבוי וקל לייצוא למערכת אחרת",
        ...
        "הרחבת OCR: אפשר לשלוח תמונה של צלחת אוכל → Google Cloud Vision API מחלץ טקסט מה-PDF/תפריט/אריזה → מועבר למודל השפה כאילו הקלדתם אותו. השירות הזה חינמי עד 1000 תמונות בחודש",
...

    {
      ...
      content: [
        ...
        "המיקום: /opt/coach-data/state.json — קובץ JSON אחד פשוט. אפשר לפתוח בעורך טקסט, לקרוא ולערוך ידנית. שקוף לחלוטין — אין קופסה שחורה",
      ...
      tips: [
        ...
        'שינוי phase ידני: POST /coach/phase עם {phase:"active"} — נוח כשרוצים להתחיל שלב חדש מיד. אפשר גם לכתוב ל-Box בוואטסאפ "בוא נעבור ל-active ממחר בבוקר" והוא יזהה את הכוונה ויעדכן לבד',
...

    {
      ...
      beginner:
        ...
        "חשבו על זה כמו 'הרשמה לערוץ יומן'. אתם נותנים ל-Google Calendar כתובת URL אחת של Box, והוא יסנכרן לבד כל כמה דקות. החלונות — מתי מותר לאכול, מתי צום — יופיעו בטלפון, בלפטופ, ובכל מכשיר שמחובר לאותו Google. אם שיניתם את שעת ההתחלה בוואטסאפ ל-Box, היומן יעודכן תוך דקות ספורות — בלי שצריך לגעת בכלום.",
...

    {
      ...
      content: [
        ...
        "דוח שבועי בוואטסאפ: כל יום שישי Box שולח סיכום: 'השבוע — התקדמות חיובית בכיוון היעד, הושלמו 12 חלונות מתוך 14, החלבון יציב'. קצר, ענייני, בלי ציון או שיפוט",
  ...
  resources: [
...

    {
      ...
      description: "Box מתחבר ל-Kami דרך intakes בוואטסאפ",
  ...
  authorBio:
    ...
    "Box בנוי כ-pattern של coach-agent לכל יעד אישי: בריאות, גמילה, שינה, לימוד וכספים. הערך האמיתי הוא שהממשק בוואטסאפ — המקום שבו המשתמש כבר נמצא, בלי אפליקציה חדשה שננטשת אחרי שבוע. המדריך מציג את הארכיטקטורה והתבנית כדי שתוכלו להתאים אותה לכל coaching use case בארגון או בחיים האישיים.",
