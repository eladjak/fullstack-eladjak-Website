...
export const boxGuide: AgentGuideData = {
  ...
  paradigmShifts: [
    {
      before: "פתח MyFitnessPal, חפש מוצר, מלא כמויות, שמור...",
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        "שמור ב-/opt/coach-abba-hatuv/progress-logs/intake.jsonl",
        "SOURCE allowlist — רק מסורות מאושרות: elad-direct-whatsapp, box-wellybox, elad-ios-shortcut",
    ...
    },
    {
      ...
      content: [
        "state.json ב-/opt/coach-abba-hatuv/state.json",
    ...
    },
    {
      ...
      difficulty: "advanced",
      content: [
        "Wellybox integration — תמונה של ארוחה → OCR → intake אוטומטי",
  ...
  resources: [
    ...
    {
      title: "Wellybox",
      description: "OCR של קבלות ומסמכים — משמש ל-intake אוטומטי",
      href: "https://wellybox.com",
      icon: ExternalLink,
    },
    {
      title: "המדריך ל-Kami",
