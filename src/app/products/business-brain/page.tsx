              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    body: 'אני לא מוכר תוכנה ומעלם. אני שם: כשהסוכן לא יודע — אני עונה. כשיש בעיה — אני פותר. שילוב של טכנולוגיה וגב אנושי שלא תמצא ב-SaaS רגיל.',
                  },
                  {
                    icon: TrendingUp,
                    title: 'מדד הצלחה מוסכם מראש',
                    body: 'לפני שמתחילים — מגדירים יחד: מה נמדד, מה מהווה הצלחה. אם אחרי 90 יום אתה לא רואה ערך מוכח — אתה יוצא בלי קנסות.',
                  },
                ].map((card, i) => {
                ...
                {[
                  {
                    ...
                    icon: Phone,
                    title: 'שיחת מיפוי',
                    desc: '30 דקות. מבינים מה אתה צריך, אילו מערכות אתה עובד איתן, ומה מדד ההצלחה שיגרום לך לדעת שהשקעת את הכסף נכון.',
                  },
                  {
                    step: '02',
                    icon: Bot,
                  ...
                  },
                  {
                    ...
                    desc: 'מהרגע שהוא חי — דוחות, תזכורות, שאלות. אתה מנהל מהטלפון. אני ברקע לכל מה שדורש שיקול דעת.',
                  },
                  {
                    step: '04',
                    icon: TrendingUp,
                    title: 'מדידה אחרי 90 יום',
                    desc: 'נושב יחד: האם עמדנו במדד שהגדרנו בתחילה? אם כן — ממשיכים ומשדרגים. אם לא — אתה יוצא בלי קנסות.',
                  },
                ].map((step, i) => {
            ...
            <div className="container px-4 md:px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                {[
                  ...
                  {
                    icon: ArrowLeft,
                    title: 'יציאה בלי קנסות',
                    desc: '30 יום הודעה מראש, ולא יותר. אין נעילה, אין ריטנשן. אם לא עובד — יוצאים.',
                  },
                ].map((item, i) => {
