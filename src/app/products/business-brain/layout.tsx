...
export const metadata: Metadata = {
  title: "מוח עסקי — עוזר ניהול עסקי בוואטסאפ | אלעד יעקובוביץ'",
  description:
    "עוזר AI אישי בוואטסאפ שמכיר את העסק שלך: דוח בוקר, תזכורות לידים וסיכום יום. ומאחוריו בן-אדם. הקמה מלאה + ליווי חודשי, החל מ-₪390 לחודש למייסדים.",
  openGraph: {
