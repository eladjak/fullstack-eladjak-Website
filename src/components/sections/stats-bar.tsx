  ...
  return (
    <section ref={ref} className="w-full py-12 md:py-16 bg-gradient-to-r from-primary/5 via-accent/5 to-primary/5 border-y border-border/20">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-3 sm:grid-cols-5 gap-6 md:gap-4">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <span className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent text-glow">
