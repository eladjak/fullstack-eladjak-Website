...
export const structuredDataGenerators = {
  ...
  faqPage: (): Record<string, unknown> => ({
    ...
    mainEntity: [
      ...
      {
        '@type': 'Question',
        name: 'מה זה רשת 9 סוכני AI שאלעד מפעיל?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'מערכת מיקרו-שירותים אישית של 9 סוכנים אוטונומיים על VPS, שמטפלים בתקשורת, מחקר, יצירת תוכן, ניהול לקוחות, מכירות, אוטומציה ועוד. אלעד בונה דומה ללקוחות.',
        },
      },
      {
        '@type': 'Question',
