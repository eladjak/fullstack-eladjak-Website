...
export const structuredDataGenerators = {
  ...
  faqPage: (): Record<string, unknown> => ({
    ...
    mainEntity: [
      ...
      {
        '@type': 'Question',
        name: 'מה זה רשת 12 סוכני ה-AI שאלעד מפעיל?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'מערכת מיקרו-שירותים אישית של 12 סוכני AI אוטונומיים על שרת Contabo — בהם קאמי (WhatsApp), קיילי (תחזוקת שרת), בוקס (מאמן אישי), גארדאקס (ניטור), ראנץ\' (תוכן) וסוליס — שמטפלים בתקשורת, מחקר, יצירת תוכן, ניהול לקוחות ואוטומציה. אלעד בונה מערכות דומות ללקוחות.',
        },
      },
      {
        '@type': 'Question',
